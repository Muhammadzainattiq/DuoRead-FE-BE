...
Tests basic functionality and authentication for the DuoRead API
"""
...
def main():
    ...
    print("DuoRead API Test Suite")
    print("Make sure your DuoRead server is running on http://localhost:8000")
